										...
										{order.map((tab, i) => (
											<React.Fragment key={tab}>
												<button
													...
													className={`inline-flex items-center gap-2 shrink-0 cursor-pointer py-1.5 px-2 rounded-md transition-colors hover:bg-[#1a1a2e]/5 ${mobileOpenCat === tab ? 'bg-[#1a1a2e]/5' : ''}`}
