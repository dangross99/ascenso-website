		...
		>
			...
			>
				<div className="px-5 py-4 bg-[#1a1a2e] text-white relative border-b border-[#C5A059]/30">
					...
					<h2 id="bookingTitle" className="text-center text-sm font-medium text-white/90 mt-2">בקשת מפרט טכני ומארז דוגמאות</h2>
				</div>
				...
				{!bookingSubmitted ? (
					<form onSubmit={handleBookingSubmit} className="bg-[#f6f7fb] text-[#0f1424] p-6">
						...
						<div className="mb-2 relative flex justify-center">
							<div className="absolute left-2 md:left-4 lg:left-20 top-1/2 -translate-y-1/2 mt-8 pointer-events-none text-[#0f1424]">
								<svg
								...
								{bookingStep !== 'time' ? (
									...
									>
										<span className="inline-flex items-center justify-center gap-2">
											<span>שלח בקשת ייעוץ הנדסי</span>
					...
					<div className="bg-white text-[#0f1424] p-8 text-center">
						...
						<p className="text-gray-600">נציגנו ייצור איתך קשר בהקדם עם מפרט טכני ומארז דוגמאות לפרויקט חיפוי הקירות.</p>
						<p className="text-gray-500 text-sm mt-2">ייעוץ הנדסי והתאמה לפרויקט שלך.</p>
						<div className="mt-6">
