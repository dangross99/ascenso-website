			...
			<div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10">
				...
				<aside ref={assignAsideRef} className="lg:col-span-4">
						...
						{(() => {
							...
							nodes.push({
								...
								el: (
									<div>
										<button
											className={`w-full flex items-center justify-between px-4 py-3 bg-white border rounded-md transition-all duration-150 hover:bg-gray-50 hover:shadow-sm active:scale-[.99] focus-visible:ring-2 focus-visible:ring-[#1a1a2e] ${mobileOpenCat === 'railing' ? 'border-[#1a1a2e] !bg-[#065F46] !text-white' : ''}`}
					...
					<div className="hidden lg:block relative border p-4 bg-white rounded-xl shadow-sm space-y-5 flex flex-col min-h-[70vh]">
						<div>
							<button
								className={`w-full flex items-center justify-between px-4 py-3 bg-white border rounded-md cursor-pointer hover:bg-gray-50 transition-all duration-150 hover:shadow-sm active:scale-[.99] focus-visible:ring-2 focus-visible:ring-[#1a1a2e] ${desktopOpenCat === 'box' ? 'border-[#1a1a2e] !bg-[#065F46] !text-white' : ''}`}
						...
						<div>
							<button
								className={`w-full flex items-center justify-between px-4 py-3 bg-white border rounded-md cursor-pointer hover:bg-gray-50 transition-all duration-150 hover:shadow-sm active:scale-[.99] focus-visible:ring-2 focus-visible:ring-[#1a1a2e] ${desktopOpenCat === 'material' ? 'border-[#1a1a2e] !bg-[#065F46] !text-white' : ''}`}
						...
						{activeMaterial === 'wood' && (
							<>
								<div>
									<button
										className={`w-full flex items-center justify-between px-4 py-3 bg-white border rounded-md cursor-pointer hover:bg-gray-50 transition-all duration-150 hover:shadow-sm active:scale-[.99] focus-visible:ring-2 focus-visible:ring-[#1a1a2e] ${desktopOpenCat === 'woodTexture' ? 'border-[#1a1a2e] !bg-[#065F46] !text-white' : ''}`}
								...
								<div>
									<button
										className={`w-full flex items-center justify-between px-4 py-3 bg-white border rounded-md cursor-pointer hover:bg-gray-50 transition-all duration-150 hover:shadow-sm active:scale-[.99] focus-visible:ring-2 focus-visible:ring-[#1a1a2e] ${desktopOpenCat === 'woodColor' ? 'border-[#1a1a2e] !bg-[#065F46] !text-white' : ''}`}
						...
						{activeMaterial !== 'wood' && (
							<div className="mt-3">
								<button
									className={`w-full flex items-center justify-between px-4 py-3 bg-white border rounded-md cursor-pointer hover:bg-gray-50 transition-all duration-150 hover:shadow-sm active:scale-[.99] focus-visible:ring-2 focus-visible:ring-[#1a1a2e] ${desktopOpenCat === 'nonWoodTexture' ? 'border-[#1a1a2e] !bg-[#065F46] !text-white' : ''}`}
