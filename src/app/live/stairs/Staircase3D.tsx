...
/** דריסת צד קיר לפי מסלול (חל על כל הדגמים). L: 0° ו־180° אותה גאומטריה; 180° = רק היפוך אופקי ימין/שמאל (צד קיר) */
	...
	function getTreads() {
		...
		if (pathSegments && pathSegments.length) {
			...
			if (isStraight) {
				...
				// L: תמיד אותה גאומטריה (X+ then Z-) – 180 = רק היפוך אופקי ימין/שמאל (צד קיר), לא רוטציה של המסלול
