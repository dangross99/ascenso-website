	...
	return (
		<>
			{treads.map((t, idx) => {
				...
				// L 0°: להפוך מדרגות ופודסט. L 180°: רק גרם ראשון ופודסט – גרם שני לא נוגעים (לא משנים אותו).
				...
				const bodyYaw = flipPodestL180 ? -Math.PI : (flipFlight0L180 || t.bodyRotate180 || flipAllL0) ? Math.PI : 0;
				return (
