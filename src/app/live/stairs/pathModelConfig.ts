...
export const SEGMENT_CONFIG: Partial<Record<PathKey, Partial<Record<BoxModel, SegmentConfig>>>> = {
	...
	U_180_landing_0: {
		rect: { mirror: false, bodyRotate180: false, landingWalls: [2, 3] },
		rounded: { mirror: false, bodyRotate180: false, landingWalls: [2, 3] },
		taper: { mirror: false, bodyRotate180: false, landingWalls: [2, 3] },
		wedge: { mirror: false, bodyRotate180: false, landingWalls: [2, 3] },
...
export function getBodyRotate180(model: string, pathKey: string): boolean {
	...
	// L0 פודסט דלתא – ערך זהה ל־SEGMENT_CONFIG.L_0_landing.taper.bodyRotate180 (גיבוי אם הלוקאפ נכשל)
