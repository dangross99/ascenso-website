									...
									<div className="p-3">
										...
										<div className="mt-3 flex justify-center">
											<a
												...
												className="inline-block px-14 py-3.5 bg-white text-[#1a1a2e] text-sm md:text-base font-bold tracking-widest rounded-md transition-colors duration-300 hover:bg-gray-200 group-hover:bg-gray-200 cursor-pointer border hover:border-gray-300 group-hover:border-gray-300"
											>
												צפייה בטקסטורה LIVE
											</a>
										</div>
				...
				>
					<div className="relative max-w-6xl max-h-[92vh] w-full h-full flex flex-col items-center justify-center gap-4" onClick={e => e.stopPropagation()}>
						...
						{lightbox.href && (
							<a
								href={lightbox.href}
								className="inline-block px-14 py-3.5 rounded-md bg-white text-[#1a1a2e] text-sm md:text-base font-bold tracking-widest shadow-sm hover:bg-gray-200 cursor-pointer transition-colors"
							>
								צפייה בטקסטורה LIVE
							</a>
						)}
