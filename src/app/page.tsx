            ...
            <div className="relative flex flex-col gap-1">
              <a href="/materials?cat=stone" className="block">
                <img
                  ...
                  alt="אבן טבעית"
                  className="w-full h-[414px] md:h-[598px] object-contain bg-transparent translate-y-4 md:translate-y-0 md:scale-[1.4] md:origin-left md:object-left lg:-translate-y-24"
                />
              </a>
            ...
            <div className="relative flex flex-col gap-1 lg:col-start-3">
              <a href="/materials?cat=wood" className="block">
                <img
                  ...
                  alt="עץ טבעי"
                  className="w-full h-[414px] md:h-[598px] object-contain bg-transparent translate-y-6 md:translate-y-0 md:scale-[1.4] md:origin-center lg:-translate-y-24"
                />
              </a>
