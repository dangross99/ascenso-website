          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-2 lg:order-1">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
                LIVE — רואים לפני שמחליטים
              </h2>
              <p className="text-gray-700 leading-relaxed mb-4">
                בהדמייה שלנו אתם בונים את המדרגות בזמן אמת: בוחרים צורה ,טקסטורות, חומרים, וסוג מעקה — זכוכית, מתכת או כבלי נירוסטה. תראו איך המדרגות זורמות בחלל, איך הפודסטים והפניות מתחברים ואיך המעקה משלים את הקו — והמחיר מתעדכן בכל שינוי. אפשר לשמור הדמיות, לשתף ב‑WhatsApp ולקבוע מדידה בשטח — הכל במקום אחד.
              </p>
