    ...
    <div className="w-full bg-white overflow-x-hidden">
      ...
      >
        ...
        <div className="relative z-10 w-full flex flex-col gap-3 justify-center items-center px-4 md:px-14 lg:px-20 pb-8 md:pb-14 lg:pb-16 md:flex-row md:items-end md:justify-between" dir="rtl">
          ...
          <div className="flex flex-col w-full md:w-auto md:mr-auto">
            <a
              href="/live"
              className="mx-auto md:mx-0 px-6 py-2 bg-white/70 text-[#1a1a2e]/80 text-base md:text-lg font-semibold shadow-sm hover:bg-white/60 transition-all duration-300 active:scale-[0.98] rounded-md border border-white/60"
            >
              התחל הזמנה
            </a>
          </div>
      ...
      <section className="w-full py-4 md:py-8" dir="rtl">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-2 md:gap-x-16 md:gap-y-12 lg:gap-x-24 lg:gap-y-16 xl:gap-x-28 xl:gap-y-20">
            {/* Stone */}
            <a href="/materials?cat=stone" className="block">
              <img
                src={encodeURI("/images/ChatGPT Image Jan 6, 2026, 12_39_36 PM.png")}
                alt="אבן טבעית"
                className="w-full h-[414px] md:h-[598px] object-contain bg-transparent md:scale-[1.3] md:origin-center"
              />
            </a>
            {/* Wood */}
