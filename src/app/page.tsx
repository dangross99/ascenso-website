            ...
            <div className="relative flex flex-col gap-1 lg:col-start-2 lg:-mt-96 lg:z-50">
              <a href="/materials?cat=metal" className="block">
                <img
                  ...
                  alt="מתכת"
                  className="w-full h-[414px] md:h-[598px] object-contain bg-transparent translate-y-3 md:translate-y-0 md:scale-[1.4] md:origin-right md:object-right lg:-translate-y-[420px]"
                />
              </a>
              <div className="absolute inset-x-0 bottom-64 md:bottom-auto md:top-32 lg:-top-[220px] z-10 px-1 text-center" dir="rtl">
