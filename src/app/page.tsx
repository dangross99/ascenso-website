...
function StairsPreview() {
  ...
  // טקסטורת עץ WAVE – גוון "אלון" (Oak) מתוך materials.json
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="order-1 lg:order-2">
              <div className="relative h-[220px] md:h-[260px] bg-transparent overflow-hidden rounded">
                <Canvas camera={{ position: [3, 7, 2.2], fov: 36 }} dpr={[1, 2]} gl={{ alpha: true, toneMappingExposure: 1.2 }} style={{ background: 'transparent' }}>
