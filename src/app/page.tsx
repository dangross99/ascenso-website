      ...
      <section className="w-full mt-8 md:mt-0 pt-4 pb-0 md:py-8" dir="rtl">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-x-4 gap-y-2 md:gap-x-20 md:gap-y-12 lg:gap-x-24 lg:gap-y-16 xl:gap-x-28 xl:gap-y-20 overflow-visible">
            ...
            <div className="relative flex flex-col gap-1 lg:col-start-2 lg:-mt-72 lg:z-40">
              <a href="/materials?cat=metal" className="block">
                <img
                  src={encodeURI("/images/ChatGPT Image Jan 6, 2026, 05_44_10 PM.png")}
                  alt="מתכת"
                  className="w-full h-[414px] md:h-[598px] object-contain bg-transparent translate-y-3 md:translate-y-0 md:scale-[1.4] md:origin-right md:object-right lg:-translate-y-[300px]"
                />
              </a>
              <div className="absolute inset-x-0 bottom-64 md:bottom-auto md:top-32 lg:-top-[160px] z-10 px-1 text-center" dir="rtl">
