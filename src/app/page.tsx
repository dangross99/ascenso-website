            ...
            <div className="relative flex flex-col gap-1">
              <a href="/materials?cat=metal" className="block">
                <img
                  ...
                  alt="מתכת"
                  className="w-full h-[414px] md:h-[598px] object-contain bg-transparent translate-y-6 md:translate-y-0 md:scale-[1.4] md:origin-right md:object-right"
                />
              </a>
              <div className="absolute inset-x-0 bottom-56 md:bottom-auto md:top-32 lg:top-32 z-10 px-1 text-center" dir="rtl">
