  ...
  return (
    <>
      ...
      <div className="w-full bg-gray-900 text-gray-100 text-xs">
        <div className="w-full px-0 md:pr-6 md:pl-0 py-3 md:py-1 flex items-center gap-3 flex-wrap justify-center md:justify-start" dir="rtl">
      ...
      <header className="w-full bg-white shadow flex flex-col items-center" suppressHydrationWarning>
        <div className="w-full relative grid grid-cols-3 items-center px-0 md:px-8 py-4 md:py-3">
